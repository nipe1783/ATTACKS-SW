...
: ${AMENT_CURRENT_PREFIX:="/home/nic/dev/ATTACKS-SW/ros_ws/install/ctrl_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ctrl_pkg/environment/library_path.sh"

...
foreach(_expectedTarget ctrl_pkg::frame_transforms)
...
# Create imported target ctrl_pkg::frame_transforms
add_library(ctrl_pkg::frame_transforms SHARED IMPORTED)

set_target_properties(ctrl_pkg::frame_transforms PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/home/linuxbrew/.linuxbrew/include/eigen3;${_IMPORT_PREFIX}/include/ctrl_pkg;${_IMPORT_PREFIX}/include"

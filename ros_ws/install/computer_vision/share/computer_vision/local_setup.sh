...
: ${AMENT_CURRENT_PREFIX:="/home/nic/dev/ATTACKS-SW/ros_ws/install/computer_vision"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/computer_vision/environment/library_path.sh"

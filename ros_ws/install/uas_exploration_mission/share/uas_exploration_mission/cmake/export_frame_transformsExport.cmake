...
foreach(_expectedTarget uas_exploration_mission::frame_transforms)
...
# Create imported target uas_exploration_mission::frame_transforms
add_library(uas_exploration_mission::frame_transforms SHARED IMPORTED)

set_target_properties(uas_exploration_mission::frame_transforms PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/home/linuxbrew/.linuxbrew/include/eigen3;${_IMPORT_PREFIX}/include/uas_exploration_mission;${_IMPORT_PREFIX}/include"
